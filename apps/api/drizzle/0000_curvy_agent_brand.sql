...
CREATE TYPE "public"."blood_group" AS ENUM('A', 'B', 'AB', 'O');--> statement-breakpoint
...
CREATE TYPE "public"."patient_state" AS ENUM('active', 'inactive');--> statement-breakpoint
CREATE TYPE "public"."review_status" AS ENUM('pending', 'confirmed', 'revoked', 'expired');--> statement-breakpoint
CREATE TYPE "public"."rh_factor" AS ENUM('positive', 'negative');--> statement-breakpoint
...
CREATE TABLE "mutuals" (
	...
	CONSTRAINT "mutuals_name_unique" UNIQUE("name"),
	CONSTRAINT "mutuals_code_unique" UNIQUE("code")
);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE "patient_mutuals" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"patient_id" uuid NOT NULL,
	"mutual_id" uuid,
	"mutual_name" varchar(150) NOT NULL,
...
CREATE TABLE "patients" (
	...
	"notes" text,
	"state" "patient_state" DEFAULT 'active' NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL
);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE "professional_mutuals" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"professional_id" uuid NOT NULL,
	"mutual_id" uuid NOT NULL,
	"is_active" boolean DEFAULT true NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL
);
...
ALTER TABLE "patient_mutuals" ADD CONSTRAINT "patient_mutuals_patient_id_patients_id_fk" FOREIGN KEY ("patient_id") REFERENCES "public"."patients"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "patient_mutuals" ADD CONSTRAINT "patient_mutuals_mutual_id_mutuals_id_fk" FOREIGN KEY ("mutual_id") REFERENCES "public"."mutuals"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "professional_mutuals" ADD CONSTRAINT "professional_mutuals_professional_id_users_id_fk" FOREIGN KEY ("professional_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "professional_mutuals" ADD CONSTRAINT "professional_mutuals_mutual_id_mutuals_id_fk" FOREIGN KEY ("mutual_id") REFERENCES "public"."mutuals"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
